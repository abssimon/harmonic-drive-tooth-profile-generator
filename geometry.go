...
// see https://github.com/psalaets/line-intersect/blob/master/src/check-intersection.js
...
func (c *Circle) Coordinates() []Point {
	num := int(math.Abs((c.Start - c.Stop) / 0.03491)) // 2 deg. circle resolution
	r := make([]Point, num)
...
// see https://www.weltderfertigung.de/suchen/lernen/mathematik/beruehrpunktberechnung-tangente-an-zwei-kreisen.php
...
// see https://math.stackexchange.com/questions/4134884
